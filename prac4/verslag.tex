...
\clearpage
\section{Inleiding}
De locatie van een meetinstrument kan van belang zijn bij het verrichtingen van metingen, bijvoorbeeld bij een branddetector in een bos. Er zijn verschillende algoritmes om een locatie te bepalen. In dit paper zal een lokalisatiealgoritme besproken worden. De besproken lokalisatie zal gedaan worden met behulp van vaste referentiepunten. Het doel van dit onderzoek is om binnen een veld van 5 bij 5 meter de positie zo nauwkeurig mogelijk proberen te bepalen. Aan de hand van het ultrasone geluid in combinatie met een positiebepalingsalgoritme wordt nauwkeurig bepaald wat de co\"{o}rdinaten zijn. 


\section{Probleemstelling}
De onderzoeksvraag die hier centraal staat: \textit{"Een algoritme opstellen waarmee met trilateratie de positie bepaald kan worden met enkele centimeters nauwkeurigheid."}
...
\end{figure}
De unisoonontvangers waarmee de signalen van de bakens worden ontvangen werden op een afstand groter dan vijf meter zeer onnauwkeurig dus is ervoor gekozen om binnen een veld van 5 bij 5 meter te werken. In het schema staan de vier bakens aangegeven met de oranje stippen samen met hun co\"{o}rdinaten. Met de roze stippen worden de testlocaties bedoeld waarop is getest. De bakens die zijn gebruikt versturen alleen signalen in de richting waarin ze wijzen. Hierdoor is het niet mogelijk correcte gegevens te verkrijgen wanneer er vanachter de bakens wordt gemeten. \\
\\
...
Het is van belang bij het testen dat er gebruik wordt gemaakt van een "schoon" grid. Dit houdt in, geen obstakels die de metingen zouden kunnen verstoren. Alle tests zijn "schoon" uitgevoerd. 
...
\\
Verwacht wordt dat de metingen zeer nauwkeurig zullen zijn met slechts enkele centimers afwijking. 
...
\begin{itemize}
	...
	\item De ultrasoonontvanger ontvangt ook echo's die weerkaatsen op objecten. Deze foutieve metingen worden meegenomen in de berekening waardoor de waarde niet meer klopt. 
\end{itemize}
