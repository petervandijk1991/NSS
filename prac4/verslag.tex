...
\section{Conclusie}
 De onderzoeksvraag die hier centraal staat: \textit{"Is het mogelijk om met een afwijking kleiner dan tien centimeter de positie van de ontvanger in een 500 bij 500 centimeter veld te bepalen?"} Uit Sectie \ref{gemiddeldes} blijkt van alle drie de gemiddelde afwijkingen dat dit minder dan 10 centimeter is, nu kan geconcludeerd worden dat de nauwkeurigheid bereikt wordt binnen een veld van vijf bij vijf meter. Er werden voor het testen twee problemen verwacht, een bit overflow en de geluidssnelheid die veranderd afhankelijk van de temperatuur en luchtvochtigheid. Uiteindelijk bleek de overflow een probleem te zijn en is de formule zoals deze in Sectie \ref{implementatie} staat uitgeschreven. Op deze manier werd de bitoverflow tegengegaan en werkte de code verder zonder last te hebben van overflow. Het tweede verwachtte probleem was de waarde voor de geluidssnelheid, omdat er een standaard waarde ingesteld is en deze niet mee veranderd met de temperatuur en luchtvochtigheid werd er verwacht dat de waarden onnauwkeuriger zouden zijn. In de praktijk was er bijna niks van te merken en zijn er hier geen meetbare afwijkingen door ontstaan.    
