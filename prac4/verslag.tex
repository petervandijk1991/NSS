...
\end{figure}\\
\\
De opstelling die hier gebruikt wordt zal als basisprincipe worden gebruikt voor de implementatie beschreven in dit paper. Aangezien in dit experiment ook gebruik wordt gemaakt van bakens die een signaal versturen en een ontvanger die dit ontvangt en op basis van die gegevens de positie bepaald. 
...
Om de implementatie te testen is er gebruik gemaakt van een testopstelling zoals die in Figuur \ref{Meetopstelling} staat weergegeven. De gebruikte hardware bestaat uit een Arduino UNO in combinatie met een ultrasoonontvanger. Daarna zal de software kort toegelicht worden en de daarbij horende constanten die zijn gebruikt.
\begin{figure}[h] 
...
In Appendix \ref{Meetresultaten} staan alle meetresultaten van de drie tests verwerkt. In de tabellen staan 25 waarden die zijn gemeten op het aangegeven co\"ordinaat. De gemiddelden hiervan zijn eronder aangegeven. De afwijkingen van deze gemiddelden zijn te vinden in Tabel \ref{table:res1}, \ref{table:res2} en \ref{table:res3}.

\begin{table}[h!]
\centering
\caption{Afwijking(290, 434) in cm}\label{table:res1}
\begin{tabular}{ |l|l| }
  \hline
  co\"ordinaat & afwijking van co\"ordinaat in cm\\ \hline \hline 
  x & 2,9 \\ \hline
  y & 5,1 \\ \hline
  (x,y) & 5,87 \\ \hline
\end{tabular}
...
\begin{table}[h!]
\centering
\caption{Afwijking (60, 155) in cm}\label{table:res2}
\begin{tabular}{ |l|l| }
  \hline
  co\"ordinaat & afwijking van co\"ordinaat in cm\\ \hline \hline 
  x & 0,4 \\ \hline
...
\begin{table}[h!]
\centering
\caption{Afwijking(72,377) in cm}\label{table:res3}
\begin{tabular}{ |l|l| }
  \hline
  co\"ordinaat & afwijking van co\"ordinaat in cm\\ \hline \hline 
  x & 3,6 \\ \hline
